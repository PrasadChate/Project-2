...
const Content = ({ selectedOption }) => {
  const cardStyle =
    "bg-white mt-6 py-4 w-[200px] text-center rounded-md font-bold cursor-pointer hover:shadow-lg transform hover:scale-105 text-blue-700 mx-6";
  const handleClick = (selectedOption, option) => {
    ...
    if (selectedOption == 3 && option == "Balance_Sheet") {
      navigate("/admin/dashboard/Balance_Sheet");
    }
  };
    ...
    <div className=" mx-4">
      ...
      {selectedOption === 0 && (
        <div className="flex">
          <div
            className={cardStyle}
            onClick={() => {
              handleClick(selectedOption, "Create");
            }}
          >
            Create
          </div>
          <div
            className={cardStyle}
            onClick={() => {
              handleClick(selectedOption, "Alter");
            }}
          >
            Alter
          </div>
          <div
            className={cardStyle}
            onClick={() => {
              handleClick(selectedOption, "Chart of Accounts");
            }}
          >
            Chart of Accounts
          </div>
      ...
      {selectedOption === 3 && (
        <div className="flex flex-wrap">
          <div
            className={cardStyle}
            onClick={() => handleClick(selectedOption, "Balance_Sheet")}
          >
            Balance Sheet
          </div>
