...
const Group = () => {
  ...
  return (
    <div className="flex justify-center items-center" style={{ backgroundColor: '#ededed', width: '100%' }}>
      <form action='POST' onSubmit={handleCreateGroup} className="p-16 rounded-lg shadow-lg" style={{ margin: '5rem', paddingLeft: '3rem', paddingRight: '3rem', backgroundColor: 'white', width: '90%' }}>
