...
const CreateOptions = () =>{
  ...
  const handleClick = (selectedOption,option) =>{
    if(selectedOption==0 && option=="Accounting Master"){
        navigate("/admin/dashboard/create/accountingmaster")
    }
    if(selectedOption==0 && option=="Inventory Master"){
        navigate("/admin/dashboard/create/inventorymaster")
    }
    if(selectedOption==0 && option=="Statutory Master"){
        navigate("/admin/dashboard/create/statutorymaster")
    }
    if(selectedOption==0 && option=="Statutory Details"){
        navigate("/admin/dashboard/create/statutorydetails")
    }
}
