...
const AlterAccountingMastersOptions = () =>{
    ...
    const handleClick = (selectedOption, option)=>{
      if(selectedOption== 0 && option=="Group"){
        navigate("/admin/dashboard/create/accountingmaster/altergroup")
      }
      if(selectedOption== 0 && option=="Ledger"){
        navigate("/admin/dashboard/create/accountingmaster/alterledger")
      }
      if(selectedOption== 0 && option=="Voucher Type"){
        navigate("/admin/dashboard/create/accountingmaster/altervoucher")
      }
    }
